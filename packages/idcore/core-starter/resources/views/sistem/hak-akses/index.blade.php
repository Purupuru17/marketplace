        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
            @forelse($listData as $item)
                <tr class="transition hover:bg-gray-50 dark:hover:bg-gray-800/60">
                    ...
                    <td class="px-6 py-4 font-medium text-gray-800 dark:text-white">{{ $item->name }}</td>
                    <td class="px-6 py-4">
                        <x-idcore::badge variant="indigo">{{ $item->permissions->count() }} permission</x-idcore::badge>
                    </td>
